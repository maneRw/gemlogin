...
module.exports.help={
  escapeElementPolicy: function (script) {
...
,
messageSandbox: function (type, data = {}) {
...
getFrames: async function (tabId) {
  try {
...
,
sendDebugCommand: function (tabId, method, params = {}) {
  return new Promise((resolve) => {
    chrome.debugger.sendCommand({ tabId }, method, params, resolve);
  });
}
,
attachDebugger: function (tabId, prevTab) {
  return new Promise((resolve) => {
...
,
waitTabLoaded: function ({ tabId, listenError = false, ms = 10000 }) {
...
,
automaRefDataStr: function (varName) {
  return `
...
,
injectPreloadScript: function ({ target, scripts, frameSelector }) {
...
,
checkCSPAndInject: async function (
